...
func NewMsgCreateReview(creator string, movieId uint64, star uint64, comment string) *MsgCreateReview {
...
func NewMsgUpdateReview(creator string, id uint64, movieId uint64, star uint64, comment string) *MsgUpdateReview {
